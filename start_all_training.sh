...
#docker run --link cs --name bot1 -p 0.0.0.0:6006:6006 user/relu_bot -n bot1 -rl True -t 0 -m TRAIN > /dev/null 2>&1 &
#docker run --link cs --name bot2 -p 0.0.0.0:6007:6006 user/relu_bot -n bot2 -rl True -t 0 -m TRAIN > /dev/null 2>&1 &
docker run --link cs --name bot5 -p 0.0.0.0:6004:6006 elbotto -n bot5 -rl True -t 1 -m TRAIN > /dev/null 2>&1 &
docker run --link cs --name bot6 -p 0.0.0.0:6005:6006 elbotto -n bot6 -rl True -t 1 -m TRAIN
